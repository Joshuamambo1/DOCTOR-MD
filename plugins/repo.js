...
async (conn, mek, m, { from, reply }) => {
    const githubRepoURL = 'https://github.com/JoshKingofc/DOCTOR-MD/tree/main/plugins';
...
> ${config.DESCRIPTION}`;
        ...
        await conn.sendMessage(from, {
            image: { url: config.MENU_IMAGE_URL || 'https://i.postimg.cc/Yqh72y8K/boykaxdlogo.jpg' },
            ...
            contextInfo: { 
                ...
                forwardedNewsletterMessageInfo: {
                    ...
                    newsletterName: config.OWNER_NAME || '𝕯𝖔𝖈𝖙𝖔𝖗-𝖒𝖉',
                    serverMessageId: 143
                }
            }
        }, { quoted: mek });
